...
public class City : MonoBehaviour
{
    ...
    {
        statsText.text = string.Format("Day: {0} Money: {1} Pop: {2}/{3} Jobs: {4}/{5} Food: {6}", new object[7] { day, money, curPopulation, maxPopulation, curJobs, maxJobs, curFood }); //Oyun ekranýnda en alttaki panelde bilgileri düzenleyecek
    }
